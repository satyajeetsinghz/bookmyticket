...
>
  {/* Hero Section with Backdrop - Responsive Height */}
  ...
  <div className="container mx-auto px-4 sm:px-6 lg:px-8 -mt-16 sm:-mt-20 relative z-10">
    <div className="flex flex-col lg:flex-row gap-6 md:gap-8">
      {/* Left Column - Responsive Width & Spacing */}
      ...
      {/* Right Column - Responsive Width & Typography */}
      <div className="w-full lg:w-2/3">
        ...
        >
          ...
          <div className="border-b border-neutral-700 mb-4 sm:mb-6">
            <nav className="flex space-x-4 sm:space-x-8">
              <button
                ...
                className={`py-2 sm:py-3 md:py-4 px-1 border-b-2 font-medium text-xs sm:text-sm ${activeTab === 'details' ? 'border-blue-600 text-blue-600' : 'border-transparent text-neutral-400 hover:text-neutral-300'}`}
              >
                Details
              </button>
              <button
                onClick={() => setActiveTab('showtimes')}
                className={`py-2 sm:py-3 md:py-4 px-1 border-b-2 font-medium text-xs sm:text-sm ${activeTab === 'showtimes' ? 'border-blue-600 text-blue-600' : 'border-transparent text-neutral-400 hover:text-neutral-300'}`}
              >
                Showtimes
              </button>
            </nav>
          ...
          {/* Booking Form - Responsive padding */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
    ...
    {/* Related Movies Section - Responsive grid */}
    <motion.section
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-2 mb-4 sm:mb-6 md:mb-8">
        ...
        <Link to="/movies" className="text-blue-600 text-xs sm:text-sm font-semibold hover:text-blue-500 flex items-center">
